...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.6_x64/ispfpga/bin/lin64/scuba -w -n lfxp2_pll_50M_360M_10M -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 50 -phase_cntl STATIC -fclkop 360 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 10 -fclkok_tol 0.0 -norst -noclkok2 

-- Thu Dec 24 22:55:12 2015
...
entity lfxp2_pll_50M_360M_10M is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        CLKOK: out std_logic; 
        LOCK: out std_logic);
end lfxp2_pll_50M_360M_10M;

architecture Structure of lfxp2_pll_50M_360M_10M is
    ...
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "10.000000";
    attribute CLKOK_DIV of PLLInst_0 : label is "36";
    attribute CLKOP_DIV of PLLInst_0 : label is "2";
    attribute CLKFB_DIV of PLLInst_0 : label is "36";
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  36, CLKOP_DIV=>  2, CLKFB_DIV=>  36, 
        CLKI_DIV=>  5)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of lfxp2_pll_50M_360M_10M is
    for Structure
