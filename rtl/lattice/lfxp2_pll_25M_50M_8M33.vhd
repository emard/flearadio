...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.6_x64/ispfpga/bin/lin64/scuba -w -n lfxp2_pll_25M_50M_8M33 -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 50 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 8.3333 -fclkok_tol 2.0 -norst -noclkok2 

-- Thu Dec 24 22:53:51 2015
...
entity lfxp2_pll_25M_50M_8M33 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        CLKOK: out std_logic; 
        LOCK: out std_logic);
end lfxp2_pll_25M_50M_8M33;

architecture Structure of lfxp2_pll_25M_50M_8M33 is
    ...
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "8.333333";
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  6, CLKOP_DIV=>  16, CLKFB_DIV=>  2, 
        CLKI_DIV=>  1)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of lfxp2_pll_25M_50M_8M33 is
    for Structure
